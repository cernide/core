from core.common.events import event_actions, event_subjects
from core.common.events.event import ActorTopEntityEvent
from core.common.events.registry.attributes import PROJECT_OWNER_ATTRIBUTES
