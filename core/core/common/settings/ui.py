...
def set_ui(context, config: PlatformConfig, processors: Optional[List[str]] = None):
    ...
    processors = [
        ...
        "core.common.settings.context_processors.version",
        "core.common.settings.context_processors.ui_assets_version",
        "core.common.settings.context_processors.ui_base_url",
        "core.common.settings.context_processors.ui_offline",
        "core.common.settings.context_processors.ui_enabled",
        "core.common.settings.context_processors.ui_in_sandbox",
    ] + processors
