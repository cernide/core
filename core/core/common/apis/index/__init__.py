...
from core.common.apis.index.errors import (
    Handler50xView,
    Handler403View,
    Handler404View,
)
from core.common.apis.index.views import IndexView
from core.common.options.registry.core import UI_ADMIN_ENABLED
...
def get_base_health_urlpatterns():
    from core.common.apis.index.health import HealthView
