...
from core.apis.project_resources.views import runs as runs_views
from core.apis.project_resources.views import versions as versions_views
from core.common.apis.urls import project_versions, projects
