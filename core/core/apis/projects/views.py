...
from core.apis.bookmarks.views import BookmarkCreateView, BookmarkDeleteView
from core.apis.endpoints.project import ProjectEndpoint
from core.apis.serializers.base.bookmarks_mixin import BookmarkedListMixinView
from core.apis.serializers.project_stats import ProjectStatsSerializer
from core.apis.serializers.projects import (
    BookmarkedProjectSerializer,
    ProjectCreateSerializer,
    ProjectDetailSerializer,
    ProjectNameSerializer,
)
from core.common.apis.filters import OrderingFilter, QueryFilter
from core.common.apis.paginator import LargeLimitOffsetPagination
from core.common.content_types import ContentTypes
from core.common.endpoints.base import (
    BaseEndpoint,
    DestroyEndpoint,
    ListEndpoint,
    PostEndpoint,
...
from core.common.endpoints.mixins import StatsMixin
from core.common.events.registry.archive import (
    PROJECT_ARCHIVED_ACTOR,
    PROJECT_RESTORED_ACTOR,
)
from core.common.events.registry.bookmark import (
    PROJECT_BOOKMARKED_ACTOR,
    PROJECT_UNBOOKMARKED_ACTOR,
)
from core.common.events.registry.project import PROJECT_STATS_ACTOR
from core.db.defs import Models
from core.db.managers.live_state import (
    archive_project,
    delete_in_progress_project,
    restore_project,
)
from core.db.managers.projects import add_project_contributors
from core.db.managers.stats import StatsSerializer
from core.db.query_managers.project import ProjectQueryManager
