...
from core.common.events.registry import run as run_events
from core.orchestration import executor
from core.orchestration.executor.handlers import APIHandler
from polyaxon.schemas import ManagedBy, V1RunPending
...
class TestExecutorRecord(TestCase):
    def setUp(self):
        ...
        from core.orchestration.executor import subscriptions  # noqa
    ...
    @patch("core.orchestration.executor.service.ExecutorService.record")
