...
from core.db.factories.artifacts import ArtifactFactory
...
from core.db.managers.live_state import archive_run, restore_run
from core.db.models.artifacts import Artifact, ArtifactLineage
from core.db.models.bookmarks import Bookmark
from core.db.models.runs import Run
from core.db.queries.artifacts import project_runs_artifacts
...
class TestProjectRunsStopViewV1(BaseTest):
    ...
    @patch("core.common.workers.send")
    def test_stop(self, _):
        ...
        with patch("core.common.auditor.record") as auditor_record:
            resp = self.client.post(self.url, data)
        assert resp.status_code == status.HTTP_200_OK
        assert set(Run.objects.only("status").values_list("status", flat=True)) == {
            V1Statuses.STOPPING,
