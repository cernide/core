...
from core.proxies.schemas.streams.base import get_base_config
...
"""  # noqa
        assert get_base_config(is_gateway=True) == expected

    def test_streams_base_config_with_gateway_dns_auth(self):
        expected = """
listen 8000;
